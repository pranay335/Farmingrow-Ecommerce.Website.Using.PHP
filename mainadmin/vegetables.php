    ...
    <section class="main">
        <div class="sidebar">
            <ul class="sidebar--items">
                ...
                <li>
                    <a href="vegetables.php" class="active">
                ...
                <li>
                    <a href="order.php">
                        ...
                        <div class="sidebar--item">Order</div>
                    </a>
                </li>
                <li>
                    <a href="stock.php">
...
<header class="newheader">
    <h1>Admin Panel - ADD VEGETABLES</h1>
</header>
...
if ($_SERVER["REQUEST_METHOD"]== "POST") 
{
    ...
    $targetFile =  basename($_FILES["image"]["name"]);
            ...
            $sql = "INSERT INTO `vegetables` (`product_id`, `product_name`, `product_price`, `product_image`, `product_detail`,`Stock`)  VALUES  (NULL,'$name', '$price', ' $targetFile','$description','$stock')";
