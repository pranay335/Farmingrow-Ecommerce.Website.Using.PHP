...
<header class="newheader">
    <h1>Admin Panel -ADD DryFruits</h1>
</header>
...
if ($_SERVER["REQUEST_METHOD"]== "POST") 
{
    ...
    $targetFile =  basename($_FILES["image"]["name"]);
            ...
            $sql = "INSERT INTO `dryfruits` (`product_id`, `product_name`, `product_price`, `product_image`, `product_detail`, `Stock`)  VALUES  (NULL,'$name', '$price', ' $targetFile','$description','$stock')";
